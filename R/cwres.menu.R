...
"cwres.menu" <- function() {
  ...
  switch(pick+1,
         qx <- 2,
         qx <- 1,
         xpose.calculate.cwres(.cur.db,classic=TRUE),
         print(cwres.wres.vs.idv(.cur.db)),
         print(basic.gof(.cur.db)),
         print(cwres.vs.idv(.cur.db)),
         print(cwres.vs.idv.bw(.cur.db)),
         print(cwres.vs.pred(.cur.db)),
         print(cwres.vs.pred.bw(.cur.db)),
         print(cwres.dist.hist(.cur.db)),
         print(cwres.dist.qq(.cur.db)),
         print(ind.plots.cwres.hist(.cur.db)),
         print(ind.plots.cwres.qq(.cur.db)),
         print(absval.cwres.vs.pred(.cur.db)),
         print(absval.cwres.vs.cov.bw(.cur.db,bins=9)),
         print(absval.cwres.vs.pred.by.cov(.cur.db)),
         print(autocorr.cwres(.cur.db))
         )
